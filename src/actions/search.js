...
import {
  extractUserPosts, formatWallPosts, parseWallPosts
...
export function finishSearch(intervalId = wallPostsSearchIntervalId) {
...
export const getPartOfResults = currentOffset => dispatch => (
  dispatch(fetchWallDataJSONP(
    ...
    .catch(e => console.info('To catch uncaught ', e))
...
//       searchQuery
//     },
//     callAPIHandler: fetchWallDataJSONP,
//     responseHandler: parseWallPosts,
//     scanEndHandler: finishSearch
//   };
// };
